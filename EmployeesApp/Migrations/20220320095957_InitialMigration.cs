        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeptAbbr = table.Column<string>(type: "varchar(5)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmpId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmpNum = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: false),
                    EmpName = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
